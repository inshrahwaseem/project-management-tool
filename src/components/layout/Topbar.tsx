  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-border bg-background/80 px-6 backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
        <button
          onClick={onMenuClick}
          className="rounded-md p-2 text-[hsl(var(--muted-foreground))] transition-colors hover:bg-[hsl(var(--muted))] lg:hidden"
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={() => {
            // Dispatch keyboard event for Ctrl+K handler
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-lg p-2 text-muted-foreground transition-all hover:bg-muted hover:text-foreground hover:shadow-sm"
