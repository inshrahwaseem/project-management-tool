      ...
      >
        <div className="w-full max-w-md space-y-6">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-muted shadow-sm"
          >
